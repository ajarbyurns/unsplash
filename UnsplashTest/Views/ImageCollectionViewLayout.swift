...
@objc public protocol ImageLayoutDelegate: UICollectionViewDelegate {
...
class ImageCollectionViewLayout: UICollectionViewLayout {
    ...
    public var delegate: ImageLayoutDelegate? {
        get {
            return collectionView!.delegate as? ImageLayoutDelegate
        }
    }
